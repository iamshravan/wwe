                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="searchdata" class="form-control" placeholder="Seacrh record (Division/Designation)" autocomplete ="off">
                                </div>

                            </div>
                            <div class="col-md-6">
                                <button  type ="submit" name="filterbutton" class="btn-link my-7">Seacrh</button>
                                <button class="btn-link my-7"><a href="display2.php" class="text-blue">Back</a>
</button>
                            </div>
                        ...
                        <table class="table table-bordered" >
                            ...
                            <tbody>
                                ...
                                if(isset($_POST['filterbutton']))
                                {
                                    ...
                                    $query = "select * from cast where concat(cdesg,divison) like '%$value_filter%' ";
